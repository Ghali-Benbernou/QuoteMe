...
import { Text, View, Image, Button, ScrollView, TouchableOpacity, TextInput } from 'react-native';
  ...
  const auth = quotes[numberholder].from;
    return (
      ...
      <ScrollView style={{flex:1, paddingTop:36, backgroundColor:'#111d5e'}}>
          ...
          <Text style={{fontSize:60, fontFamily:'Sarpanch-Bold'}}>"</Text> Quote Me !</Text> 
          ...
          <View style={{flexDirection: "column", borderColor: 'black', borderWidth: 1 , backgroundColor:'white',
          borderRadius:100/4}}>
          <Text style={{color:'black',fontSize:20, padding:10,fontStyle:'italic'}}>
            "{quote}"</Text>
      ...
      <TouchableOpacity 
          style={{backgroundColor:'white',marginBottom:30, height:50, width:200, borderRadius:100/3,
